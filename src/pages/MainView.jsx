...
const portfolioData = {
  ...
  projects: [
    ...
    { title: "Online Clothing Shop (Ongoing)", description: "Developed a responsive MERN stack e-commerce platform for a clothing shop. Contributed to building the login page, shopping cart, and order management features to enhance user experience and streamline online purchases.", technologies: ["React", "Node(Express)", "MongoDB"], liveLink: "#", githubLink: "https://github.com/cycotechnolgies/Online-Clothing-Shop.git",icon: clothshop},
  ],
  contact: {
